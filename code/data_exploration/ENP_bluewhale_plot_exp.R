...
input_dir <- "data/confidential/stan_output/Blue_whale"
...
output_clean <- output %>%
  ...
  mutate(N_over_K = ifelse(estimation_type == "mean", estimation/2323, NA)) %>%
...
ggsave(g_abundance, filename=file.path(plot_dir, "ENP_bluewhale_abd_est.png"), 
